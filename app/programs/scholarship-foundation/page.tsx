...
export const metadata: Metadata = buildMetadata({
  title: "Sigma Lambda Scholarship Foundation",
  description: "Sigma Lambda Scholarship Foundation — a Sigma Lambda Chapter initiative of Alpha Phi Alpha Fraternity, Inc. in New Orleans, Louisiana.",
  path: "/programs/scholarship-foundation",
});

const backLinkClass =
  "inline-block text-[13px] font-bold tracking-[0.03em] uppercase focus-visible:outline-gold-bright";

export default function ScholarshipFoundationPage() {
  return (
